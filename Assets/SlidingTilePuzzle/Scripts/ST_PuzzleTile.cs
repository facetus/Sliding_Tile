...
public class ST_PuzzleTile : MonoBehaviour 
{
    ...
    {
        // Set the initial position of the UI element.
        tileImage.rectTransform.anchoredPosition = position;

        // Set the sprite for the puzzle piece.
        tileImage.sprite = sprite;

        // Hook up the button click event to your custom logic.
        tileButton.onClick.AddListener(OnTileClicked);
    }

    // Implement your custom logic for tile click.
